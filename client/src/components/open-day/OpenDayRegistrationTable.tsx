        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-accent/50">
              <TableHead className="text-right font-bold text-xs w-10">
                #
              </TableHead>
              ...
              <TableHead className="text-right font-bold text-xs">
                {t("table.interestedTrack")}
              </TableHead>
              <TableHead className="text-right font-bold text-xs">
                {t("table.currentSchool")}
              </TableHead>
              <TableHead className="text-right font-bold text-xs">
                {t("table.parentName")}
              </TableHead>
            ...
            {regsLoading ? (
              ...
              registrations.items.map((reg, index) => (
                <TableRow key={reg.id}>
                  ...
                  <TableCell className="text-sm py-2">
                    {reg.interested_track ?? "-"}
                  </TableCell>
                  <TableCell
                    className="text-sm py-2 max-w-32 truncate"
                    title={reg.current_school ?? ""}
                  >
                    {reg.current_school ?? "-"}
                  </TableCell>
                  <TableCell className="text-sm py-2">
