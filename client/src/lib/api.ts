...
export const analyticsApi = {
  ...
  getClassHeatmap: (classId: string, params: { period?: string } = {}) =>
    fetchApi<HeatmapData>(
      `/api/analytics/class/${classId}/heatmap${buildQueryString(params)}`,
    ),
  ...
  getTeachersList: (params: { period?: string; grade_level?: string } = {}) =>
    fetchApi<TeacherListItem[]>(
      `/api/analytics/teachers/list${buildQueryString(params)}`,
    ),
...
export const studentsApi = {
  ...
  getClasses: (params: { period?: string } = {}) =>
    fetchApi<ClassResponse[]>(
      `/api/students/classes${buildQueryString(params)}`,
    ),
};
...
export const advancedAnalyticsApi = {
  getPeriodComparison: (params: {
    ...
    fetchApi<PeriodComparisonResponse>(
      `/api/advanced-analytics/period-comparison${buildQueryString(params)}`,
    ),
  ...
  getRedStudentSegmentation: (
    ...
    fetchApi<RedStudentSegmentation>(
      `/api/advanced-analytics/red-students/segmentation${buildQueryString(params)}`,
    ),
  ...
  getRedStudentList: (
    ...
    fetchApi<RedStudentListResponse>(
      `/api/advanced-analytics/red-students/list${buildQueryString(params)}`,
    ),
  ...
  getVersusComparison: (params: {
    ...
    fetchApi<VersusChartData>(
      `/api/advanced-analytics/versus${buildQueryString(params)}`,
    ),
  ...
  getCascadingFilterOptions: (
    ...
    fetchApi<CascadingFilterOptions>(
      `/api/advanced-analytics/filter-options${buildQueryString(params)}`,
    ),
};
