...
function SubjectDetailPage() {
    ...
    const { data: subject, isLoading } = useQuery({
        ...
        queryFn: () => analyticsApi.getSubjectDetail(subjectId, { year: filters.year, period: filters.period }),
    });

    const classChartData = subject?.classes.map((cls) => ({
        name: cls.name,
    ...
    return (
        <div className="space-y-4">
            ...
            <PageHeader
                ...
                stats={[
                    { value: subject.stats.average_grade?.toFixed(1) || "—", label: tc("table.average") },
